...
+ (void)initialize
{
    ...
    appearance.titleFont = [UIFont fontWithName:@"Futura" size:25.0f];
    appearance.messageFont = [UIFont fontWithName:@"Futura" size:18.0f];
    appearance.buttonFont = [UIFont fontWithName:@"Futura" size:20.0f];
